...
from pydftlib import pydftlib
from pydftlib.pydftlib import bin2hstr, getRandomSeed, str2bin, bin2mnemonic, mnemonic2bin  # noqa
from pydftlib.pydftlib import XmssFast, dftDescriptor

hash_functions = {
    "shake128": pydftlib.SHAKE_128,
    "shake256": pydftlib.SHAKE_256,
    "sha2_256": pydftlib.SHA2_256
}
...
class XMSS(object):
    ...
    def from_extended_seed(extended_seed: bytes):
        ...
        descr = dftDescriptor.fromBytes(extended_seed[0:3])
        if descr.getSignatureType() != pydftlib.XMSS:
    ...
    def __init__(self, _xmssfast):
        ...
        >>> from dft.crypto.doctest_data import *
