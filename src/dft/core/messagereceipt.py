...
from dft.generated.dftlegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        dftlegacy_pb2.LegacyMessage.VE: 'veData',
        dftlegacy_pb2.LegacyMessage.PL: 'plData',
        dftlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        dftlegacy_pb2.LegacyMessage.MR: 'mrData',
        dftlegacy_pb2.LegacyMessage.SFM: 'mrData',

        dftlegacy_pb2.LegacyMessage.BK: 'block',
        dftlegacy_pb2.LegacyMessage.FB: 'fbData',
        dftlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        dftlegacy_pb2.LegacyMessage.TX: 'txData',
        dftlegacy_pb2.LegacyMessage.MT: 'mtData',
        dftlegacy_pb2.LegacyMessage.TK: 'tkData',
        dftlegacy_pb2.LegacyMessage.TT: 'ttData',
        dftlegacy_pb2.LegacyMessage.LT: 'ltData',
        dftlegacy_pb2.LegacyMessage.SL: 'slData',

        dftlegacy_pb2.LegacyMessage.EPH: 'ephData',

        dftlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        dftlegacy_pb2.LegacyMessage.MC: 'mcData',
        dftlegacy_pb2.LegacyMessage.MS: 'msData',
        dftlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[dftlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = dftlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
