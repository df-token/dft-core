...
from pydftlib.pydftlib import shake128, bin2hstr

from dft.core.config import DevConfig, user as user_config
from dft.core.formulas import block_reward
...
class BlockHeader(object):
    def __init__(self, protobuf_blockheader=None):
        ...
        if protobuf_blockheader is None:
            self._data = dft_pb2.BlockHeader()
