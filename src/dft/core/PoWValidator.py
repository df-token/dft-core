...
from dft.core.Singleton import Singleton
from dft.core.miners.qryptonight7.CNv1PoWValidator import CNv1PoWValidator
from dft.core.miners.qrandomx.QRXPoWValidator import QRXPoWValidator
