...
from pydftlib.pydftlib import dftHelper, hstr2bin, sha2_256
...
class MultiSigAddressState(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = dft_pb2.MultiSigAddressState()
    ...
    def pbdata(self):
        ...
        :rtype: dft_pb2.MultiSigAddressState
        """
        return self._data
    ...
    def address_is_valid(address: bytes) -> bool:
        ...
        if not dftHelper.addressIsValid(address):
            return False
    ...
    def get_multi_sig_address_state(state: State,
        ...
        try:
            ...
            pbdata = dft_pb2.MultiSigAddressState()
