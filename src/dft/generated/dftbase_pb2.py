...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='dft',
  syntax='proto3',
  serialized_pb=_b('\n\rdftbase.proto\x12\x03dft\"\x10\n\x0eGetNodeInfoReq\"5\n\x0fGetNodeInfoResp\x12\x0f\n\x07version\x18\x01 \x01(\t\x12\x11\n\tgrpcProto\x18\x02 \x01(\t2B\n\x04\x42\x61se\x12:\n\x0bGetNodeInfo\x12\x13.dft.GetNodeInfoReq\x1a\x14.dft.GetNodeInfoResp\"\x00\x62\x06proto3')
)
...
_GETNODEINFORESP = _descriptor.Descriptor(
  ...
  full_name='dft.GetNodeInfoResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='dft.GetNodeInfoResp.version', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='grpcProto', full_name='dft.GetNodeInfoResp.grpcProto', index=1,
...
GetNodeInfoReq = _reflection.GeneratedProtocolMessageType('GetNodeInfoReq', (_message.Message,), dict(
  ...
  __module__ = 'dftbase_pb2'
  # @@protoc_insertion_point(class_scope:dft.GetNodeInfoReq)
  ))
...
GetNodeInfoResp = _reflection.GeneratedProtocolMessageType('GetNodeInfoResp', (_message.Message,), dict(
  ...
  __module__ = 'dftbase_pb2'
  # @@protoc_insertion_point(class_scope:dft.GetNodeInfoResp)
  ))
...
_BASE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetNodeInfo',
    full_name='dft.Base.GetNodeInfo',
    index=0,
