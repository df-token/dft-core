...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='dft',
  syntax='proto3',
  serialized_pb=_b('\n\x0edftdebug.proto\x12\x03dft\x1a\tdft.proto\"\x11\n\x0fGetFullStateReq\"i\n\x10GetFullStateResp\x12)\n\x0e\x63oinbase_state\x18\x01 \x01(\x0b\x32\x11.dft.AddressState\x12*\n\x0f\x61\x64\x64resses_state\x18\x02 \x03(\x0b\x32\x11.dft.AddressState2G\n\x08\x44\x65\x62ugAPI\x12;\n\x0cGetFullState\x12\x14.dft.GetFullStateReq\x1a\x15.dft.GetFullStateRespb\x06proto3')
  ,
...
_GETFULLSTATERESP = _descriptor.Descriptor(
  ...
  full_name='dft.GetFullStateResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='coinbase_state', full_name='dft.GetFullStateResp.coinbase_state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='addresses_state', full_name='dft.GetFullStateResp.addresses_state', index=1,
...
_GETFULLSTATERESP.fields_by_name['coinbase_state'].message_type = dft__pb2._ADDRESSSTATE
_GETFULLSTATERESP.fields_by_name['addresses_state'].message_type = dft__pb2._ADDRESSSTATE
...
GetFullStateReq = _reflection.GeneratedProtocolMessageType('GetFullStateReq', (_message.Message,), dict(
  ...
  __module__ = 'dftdebug_pb2'
  # @@protoc_insertion_point(class_scope:dft.GetFullStateReq)
  ))
...
GetFullStateResp = _reflection.GeneratedProtocolMessageType('GetFullStateResp', (_message.Message,), dict(
  ...
  __module__ = 'dftdebug_pb2'
  # @@protoc_insertion_point(class_scope:dft.GetFullStateResp)
  ))
...
_DEBUGAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetFullState',
    full_name='dft.DebugAPI.GetFullState',
    index=0,
