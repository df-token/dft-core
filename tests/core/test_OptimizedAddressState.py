...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, set_dft_dir
...
class TestOptimizedAddressState(TestCase):
    ...
    @patch('dft.core.config.DevConfig.ots_tracking_per_page', new_callable=PropertyMock, return_value=1024)
    @patch('dft.core.config.DevConfig.ots_bitfield_size', new_callable=PropertyMock)
