...
from tests.misc.helper import set_dft_dir, get_alice_xmss, replacement_getTime, gen_blocks

logger.initialize_default()


@mock.patch('dft.core.misc.ntp.getTime', new=replacement_getTime)
class TestState(TestCase):
    ...
    def test_get_block_size_limit(self):
        ...
        with patch('dft.core.Block.Block.get_block', return_value=None):
