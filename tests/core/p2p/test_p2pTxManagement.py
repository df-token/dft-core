...
class TestP2PTxManagement(TestCase):
    ...
    def test_notification(self):
        ...
        event = dftlegacy_pb2.LegacyMessage(func_name=dftlegacy_pb2.LegacyMessage.TX,
                                            txData=tx.pbdata)
    ...
    @patch('dft.core.p2p.p2pTxManagement.logger')
...
class TestP2PTxManagementHandlers(TestCase):
    ...
    def test_handle_message_received(self):
        ...
        :return:
        """
        mrData = dftlegacy_pb2.MRData(type=dftlegacy_pb2.LegacyMessage.SL)
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_ignores_unknown_message_types(self):
        mrData = dftlegacy_pb2.MRData(type=999)
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_transactions_ignored_while_unsynced(self):
        ...
        mrData = dftlegacy_pb2.MRData(type=dftlegacy_pb2.LegacyMessage.TX)
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_ignores_blocks(self):
        ...
        mrData = dftlegacy_pb2.MRData(type=dftlegacy_pb2.LegacyMessage.BK,
    ...
    @patch('dft.core.p2p.p2pTxManagement.Transaction')
    def test_handle_message_transaction(self, m_Transaction):
        ...
        mtData = dft_pb2.Transaction()
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.MT, mtData=mtData)
...
class TestP2PTxManagementSimpleHandlers(TestCase):
    ...
    def test_handle_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.TK, tkData=dft_pb2.Transaction())
    ...
    def test_handle_transfer_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.TT, ttData=dft_pb2.Transaction())
    ...
    def test_handle_lattice(self, m_Transaction, m_logger):
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.LT, ltData=dft_pb2.Transaction())
    ...
    def test_handle_slave(self, m_Transaction, m_logger):
        msg = make_message(func_name=dftlegacy_pb2.LegacyMessage.SL, slData=dft_pb2.Transaction())
