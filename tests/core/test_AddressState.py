...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, get_random_xmss, set_dft_dir
...
class TestAddressState(TestCase):
    ...
    @patch('dft.core.AddressState.AddressState.transaction_hashes', new_callable=PropertyMock)
