...
from dft.core.Miner import Miner
from dft.core.TransactionPool import TransactionPool
from dft.core.misc.helper import parse_qaddress
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('dft.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('dft.core.Miner.Block.create')
