...
from tests.misc.helper import get_alice_xmss, get_slave_xmss, get_bob_xmss, set_dft_dir
...
class TestSlaveTransaction(TestCase):
    ...
    def test_validate_extended(self, m_validate_slave, m_logger):
        ...
        # fee = -1
        with patch('dft.core.txs.SlaveTransaction.SlaveTransaction.fee', new_callable=PropertyMock) as m_fee:
