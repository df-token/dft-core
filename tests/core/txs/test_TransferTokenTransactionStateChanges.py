...
from dft.generated.dft_pb2 import TokenBalance
...
class TestTransferTokenTransactionStateChanges(TestCase):
    ...
    def test_apply_transfer_token_txn(self):
        """
        Alice has 1000 tokens and 100 dft, Bob has none. Alice sends some tokens to Bob.
        """
    ...
    def test_apply_transfer_token_txn_multi_send(self):
        """
        Alice has 1000 tokens and 100 dft, Bob and Slave have none. Alice sends some tokens to Bob and Slave.
        """
    ...
    def test_apply_transfer_token_txn_send_tokens_to_self(self):
        """
        Alice has 1000 tokens and 100 dft. She sends some tokens to herself. What happens next?
        """
    ...
    def test_revert_transfer_token_txn_multi_send(self):
        """
        Alice has 1100 tokens and 100 dft, Bob and Slave have none. Alice sends some tokens to Bob and Slave.
        Undo this.
        """
        slave = get_slave_xmss()
    ...
    def test_revert_transfer_token_txn_send_tokens_to_self(self):
        """
        Alice has 1000 tokens and 100 dft. She sends some tokens to herself.
        Can we undo this?
        """
        self.params["addrs_to"] = [self.alice.address]
        tx = TransferTokenTransaction.create(**self.params)
