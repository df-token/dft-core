...
from pydftlib.pydftlib import bin2hstr, dftHelper
...
from tests.misc.helper import get_alice_xmss, get_bob_xmss, set_default_balance_size, set_dft_dir, replacement_getTime
    ...
    def test_messageTxn_sign(self):
        with set_dft_dir('wallet_ver1'):
            with State() as db_state:
                ...
                my_message = b'Hello dft!'

                request = dft_pb2.MessageTxnReq(
                    message=my_message,
                    fee=12,
                    xmss_pk=alice.pk
                )
                ...
                req_push = dft_pb2.PushTransactionReq(transaction_signed=signed_transaction)
                ...
                self.assertEqual(dft_pb2.PushTransactionResp.SUBMITTED,
    ...
    def test_transferCoins_get_unsigned(self):
        with set_dft_dir('wallet_ver1'):
            with State() as db_state:
                ...
                request = dft_pb2.TransferCoinsReq(
    ...
    def test_transferCoins_push_unsigned(self):
        with set_dft_dir('wallet_ver1'):
            with State() as db_state:
                ...
                req_push = dft_pb2.PushTransactionReq(transaction_signed=response.extended_transaction_unsigned.tx)
                ...
                self.assertIsNotNone(resp_push)
                self.assertEqual(dft_pb2.PushTransactionResp.VALIDATION_FAILED,
                                 resp_push.error_code)
    ...
    def test_transferCoins_sign(self):
        with set_dft_dir('wallet_ver1'):
            with State() as db_state:
                ...
                tmp_hash_pre = bytes(dftHelper.getAddress(response.extended_transaction_unsigned.tx.public_key))
