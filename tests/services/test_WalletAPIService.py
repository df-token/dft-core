...
from pydftlib.pydftlib import bin2hstr, hstr2bin

from dft.core.misc import logger
from dft.core.AddressState import AddressState
from dft.daemon.walletd import WalletD
from dft.generated import dftwallet_pb2, dft_pb2
from dft.services.WalletAPIService import WalletAPIService
from tests.misc.helper import get_alice_xmss, get_bob_xmss, set_dft_dir, replacement_getTime
...
class TestWalletAPI(TestCase):
    ...
    def test_addNewAddress(self):
        with set_dft_dir("wallet_ver1"):
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddNewAddress(dftwallet_pb2.AddNewAddressReq(), context=None)
    ...
    def test_addNewAddressWithSlaves(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.PushTransaction = Mock(
                return_value=dft_pb2.PushTransactionResp(error_code=dft_pb2.PushTransactionResp.SUBMITTED))

            service = WalletAPIService(walletd)
            resp = service.AddNewAddressWithSlaves(dftwallet_pb2.AddNewAddressWithSlavesReq(), context=None)
            self.assertEqual(resp.code, 0)
            self.assertEqual(resp.address[0], 'Q')
    ...
    def test_addAddressFromSeed(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddAddressFromSeed(dftwallet_pb2.AddAddressFromSeedReq(seed=hex_seed), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_addAddressFromSeed2(self):
        with set_dft_dir("wallet_ver1"):
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddAddressFromSeed(dftwallet_pb2.AddAddressFromSeedReq(seed=self.mnemonic), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_listAddresses(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.ListAddresses(dftwallet_pb2.ListAddressesReq(), context=None)
    ...
    def test_removeAddress(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RemoveAddress(dftwallet_pb2.RemoveAddressReq(address=address), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_isValidAddress(self):
        with set_dft_dir("wallet_ver1"):
            ...
            qaddress = "Q010400ff39df1ba4d1d5b8753e6d04c51c34b95b01fc3650c10ca7b296a18bdc105412c59d0b3b"
            resp = service.IsValidAddress(dftwallet_pb2.ValidAddressReq(address=qaddress), context=None)
    ...
    def test_getRecoverySeeds(self):
        with set_dft_dir("wallet_ver1"):
            ...
            service.AddAddressFromSeed(dftwallet_pb2.AddAddressFromSeedReq(seed=self.mnemonic), context=None)
            resp = service.GetRecoverySeeds(dftwallet_pb2.GetRecoverySeedsReq(address=self.qaddress), context=None)
    ...
    def test_getWalletInfo(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.GetWalletInfo(dftwallet_pb2.GetWalletInfoReq(), context=None)
    ...
    def test_relayTransferTxn(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetAddressState = Mock(
                return_value=dft_pb2.GetAddressStateResp(state=addr_state.pbdata))
            walletd._public_stub.IsSlave = Mock(
                return_value=dft_pb2.IsSlaveResp(result=True))
            walletd._public_stub.GetOTS = Mock(
                return_value=dft_pb2.GetOTSResp(next_unused_ots_index=0,
            ...
            resp = service.RelayTransferTxn(dftwallet_pb2.RelayTransferTxnReq(addresses_to=qaddresses_to,
                                                                              amounts=amounts,
                                                                              fee=100000000,
                                                                              master_address=None,
    ...
    def test_relayTransferTxnBySlave(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTxnBySlave(
                dftwallet_pb2.RelayTransferTxnBySlaveReq(addresses_to=qaddresses_to,
                                                         amounts=amounts,
                                                         fee=100000000,
    ...
    def test_relayMessageTxn(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayMessageTxn(dftwallet_pb2.RelayMessageTxnReq(message=b'Hello dft!',
                                                                            fee=100000000,
                                                                            master_address=None,
                                                                            signer_address=qaddress,
                                                                            ots_index=0), context=None)
    ...
    def test_relayMessageTxnBySlave(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayMessageTxnBySlave(
                dftwallet_pb2.RelayMessageTxnReq(message=b'Hello dft!',
                                                 fee=100000000,
                                                 master_address=qaddress), context=None)
    ...
    def test_relayTokenTxn(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayTokenTxn(dftwallet_pb2.RelayTokenTxnReq(symbol=b'dft',
    ...
    def test_relayTokenTxnBySlave(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayTokenTxnBySlave(
                dftwallet_pb2.RelayTokenTxnBySlaveReq(symbol=b'dft',
                                                      name=b'Quantum Resistant Ledger',
                                                      owner=alice_xmss.qaddress,
                                                      decimals=5,
                                                      addresses=qaddresses,
    ...
    def test_relayTransferTokenTxn(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTokenTxn(dftwallet_pb2.RelayTransferTokenTxnReq(addresses_to=qaddresses_to,
                                                                                        amounts=amounts,
                                                                                        token_txhash='',
                                                                                        fee=100000000,
                                                                                        master_address=None,
    ...
    def test_relayTransferTokenTxnBySlave(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTokenTxnBySlave(
                dftwallet_pb2.RelayTransferTokenTxnBySlaveReq(addresses_to=qaddresses_to,
                                                              amounts=amounts,
                                                              token_txhash='',
                                                              fee=100000000,
                                                              master_address=qaddress), context=None)
    ...
    def test_relaySlaveTxn(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelaySlaveTxn(dftwallet_pb2.RelaySlaveTxnReq(slave_pks=slave_pks,
    ...
    def test_relaySlaveTxnBySlave(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.RelaySlaveTxnBySlave(
                dftwallet_pb2.RelaySlaveTxnBySlaveReq(slave_pks=slave_pks,
                                                      access_types=access_types,
                                                      fee=100000000,
                                                      master_address=qaddress), context=None)
    ...
    def test_encryptWallet(self):
        with set_dft_dir("wallet_ver1"):
            ...
            service.AddNewAddress(dftwallet_pb2.AddNewAddressReq(), context=None)

            resp = service.EncryptWallet(dftwallet_pb2.EncryptWalletReq(), context=None)
            self.assertEqual(resp.code, 1)

            resp = service.EncryptWallet(dftwallet_pb2.EncryptWalletReq(passphrase=self.passphrase), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_lockWallet(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.UnlockWallet(dftwallet_pb2.UnlockWalletReq(passphrase=self.passphrase), context=None)
            self.assertEqual(resp.code, 0)

            resp = service.ListAddresses(dftwallet_pb2.ListAddressesReq(), context=None)
            self.assertEqual(resp.code, 0)

            resp = service.LockWallet(dftwallet_pb2.LockWalletReq(), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_unlockWallet(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.UnlockWallet(dftwallet_pb2.UnlockWalletReq(), context=None)
            self.assertEqual(resp.code, 1)

            resp = service.UnlockWallet(dftwallet_pb2.UnlockWalletReq(passphrase="wrong"), context=None)
            self.assertEqual(resp.code, 1)
    ...
    def test_changePassphrase(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.ChangePassphrase(
                dftwallet_pb2.ChangePassphraseReq(oldPassphrase=self.passphrase,
            ...
            resp = service.UnlockWallet(dftwallet_pb2.UnlockWalletReq(passphrase=new_passphrase), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_getTransactionsByAddress(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetMiniTransactionsByAddress = Mock(
                return_value=dft_pb2.GetMiniTransactionsByAddressResp(mini_transactions=[],
                                                                      balance=0))

            resp = service.GetTransactionsByAddress(
                dftwallet_pb2.TransactionsByAddressReq(address=get_alice_xmss(4).qaddress), context=None)
    ...
    def test_getTransaction(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTransaction = Mock(
                return_value=dft_pb2.GetTransactionResp(tx=tx, confirmations=10))

            resp = service.GetTransaction(dftwallet_pb2.TransactionReq(tx_hash=tx.transaction_hash), context=None)
    ...
    def test_getBalance(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetBalance = Mock(
                return_value=dft_pb2.GetBalanceResp(balance=1000))

            resp = service.GetBalance(dftwallet_pb2.BalanceReq(address=self.qaddress), context=None)
    ...
    def test_getTotalBalance(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTotalBalance = Mock(
                return_value=dft_pb2.GetTotalBalanceResp(balance=6000))

            resp = service.GetTotalBalance(dftwallet_pb2.TotalBalanceReq(), context=None)
    ...
    def test_getOTS(self):
        with set_dft_dir("wallet_ver1"):
            ...
            ots_bitfield_by_page = dft_pb2.OTSBitfieldByPage(ots_bitfield=[b'\x00'] * 10,
                                                             page_number=1)
            walletd._public_stub.GetOTS = Mock(
                return_value=dft_pb2.GetOTSResp(ots_bitfield_by_page=[ots_bitfield_by_page],
                                                next_unused_ots_index=1,
                                                unused_ots_index_found=True))

            resp = service.GetOTS(dftwallet_pb2.OTSReq(address=self.qaddress), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_getHeight(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetHeight = Mock(
                return_value=dft_pb2.GetHeightResp(height=1001))

            resp = service.GetHeight(dftwallet_pb2.HeightReq(), context=None)
    ...
    def test_getBlock(self):
        with set_dft_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetBlock = Mock(
                return_value=dft_pb2.GetBlockResp(block=block))

            resp = service.GetBlock(dftwallet_pb2.BlockReq(header_hash=b'001122'), context=None)
    ...
    def test_getBlockByNumber(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.GetBlockByNumber(dftwallet_pb2.BlockByNumberReq(block_number=1), context=None)
    ...
    def test_getAddressFromPK(self):
        with set_dft_dir("wallet_ver1"):
            ...
            resp = service.GetAddressFromPK(dftwallet_pb2.AddressFromPKReq(pk=pk), context=None)
    ...
    def test_getNodeInfo(self):
        with set_dft_dir("wallet_ver1"):
            ...
            node_info = dft_pb2.NodeInfo(version=version,
            ...
            walletd._public_stub.GetNodeState = Mock(
                return_value=dft_pb2.GetNodeStateResp(info=node_info))

            resp = service.GetNodeInfo(dftwallet_pb2.NodeInfoReq(), context=None)
