...
class TestBlockchain(TestCase):
    ...
    def test_forking_basic(self):
        ...
        with MockedBlockchain.create(number_blocks) as mock_blockchain:
            # Fork at node 9
            block_9 = mock_blockchain.dftnode.get_block_from_index(9)
            block_10 = mock_blockchain.dftnode.get_block_last()
            ...
            last_block = mock_blockchain.dftnode.get_block_last()
            block_index_10 = mock_blockchain.dftnode.get_block_from_index(10)
    ...
    def test_forking_basic2(self):
        ...
        with MockedBlockchain.create(number_blocks) as mock_blockchain:
            ...
            block_index_10 = mock_blockchain.dftnode.get_block_from_index(10)
            block_index_11 = mock_blockchain.dftnode.get_block_from_index(11)
    ...
    def test_forking_basic3(self):
        ...
        with MockedBlockchain.create(number_blocks) as mock_blockchain:
            ...
            block_index_10 = mock_blockchain.dftnode.get_block_from_index(10)
            block_index_11 = mock_blockchain.dftnode.get_block_from_index(11)
            block_index_12 = mock_blockchain.dftnode.get_block_from_index(12)
